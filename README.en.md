...
| **Code quality** | No type hints, no tests | Type-annotated + **93 pytest tests** + CI |
| **Country display** | English only | Chinese mapping (180+ countries) |
| **Code size** | 316 lines, single file | 1400 lines + 93 tests + 2067-platform DB |
...
├── tests/
│   ├── __init__.py
│   └── test_ghosttrack.py      # 93 pytest tests
├── .github/
