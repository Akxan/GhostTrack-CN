...
[![Tests](https://img.shields.io/badge/tests-248%20passed-success.svg)](tests/)
...
- **248 pytest tests**: 5-pronged audit clean (ruff / mypy / bandit / pytest / agent)
...
- ✅ **248 tests**, ~0.4 seconds (v1.0.0 comprehensive coverage)
...
│   ├── test_spyeyes.py         # Core tests (199)
